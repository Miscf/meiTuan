...
response = requests.post('https://wmapi.meituan.com/api/v6/comment/poi', headers=headers, params=params, data=data)
...
print(len(response.json().get("data").get('comments')))
